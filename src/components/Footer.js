        ...
        <>
            ...
            <footer id="Footer" className="clr footerMain">
                            ...
                            <div id="asyncFooterHtml">
                                <div className="f-prt">
                                    ...
                                    <div className="pull-left pr-20 mr-20">
                                        <span className="ft-link">Link 1</span>
                                        <span className="ft-link">Link 2</span>
                                        <span className="ft-link">Link 3</span>
                                        <span className="ft-link">Link 4</span>
                                        <span className="ft-link">Link 5</span>
                                        <span className="ft-link">Link 6</span>
                                        <span className="ft-link">Link 7</span>
                                        <span className="ft-link">Link 8</span>
                                    </div>
                                </div>
                                <div className="f-prt">
                                ...
                                <div className="f-prt ">
                                    <div className="f-follow-box f-mr-top">
                                        <div className="f-follow-us pull-left">
                                            ...
                                            <a target="_blank" href="https://www.facebook.com/askresidenciofficial">
                                            ...
                                            <a target="_blank" href="https://www.instagram.com/askresidenci_official">
                                                <span className="f-sl mr-10 c-p">
                                                    <span className="f-sprite f-insta"></span>
                                                </span>
                                            </a>
                                            <a target="_blank" href="https://www.youtube.com/channel/UC0z7t5Yx0eoUmiHuaajmXVg">
                                                <span className="f-sl mr-10 c-p">
                ...
                <div className="f-btm clr">
                    ...
                    <div className="f-b-txt pull-right">Copyright © 2023 Powered By <span className="c-p">AskResidenci.com</span> All Rights Reserved.</div>
                    </div>
                </div>
            </footer>
        </>
