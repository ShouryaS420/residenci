...
export default function ViewDetails() {
    ...
    // Project Nearby Locality show by project id start
        ...
        useEffect(() => {
            ...
            fetch(`https://askresidenci.com/fetchProjectNearbyLocalityByProjectID.php?projectId=${id}`)
                .then(response => response.json())
                .then(data => {
                    setProjectLocality(data);
                })
                .catch(error => console.error('Error fetching project localities:', error));
        }, [id]);
    ...
    // Project variant show by project id start
        ...
        useEffect(() => {
            // Fetch project localities using the PHP API
            fetch(`https://askresidenci.com/fetchProjectVariantByProjectID.php?projectId=${id}`)
                .then(response => response.json())
                .then(data => {
                    setProjectVariants(data);
                })
                .catch(error => console.error('Error fetching project localities:', error));
        }, [id]);
    ...
    // show developer data by builderID which is present in developer database start
        ...
        useEffect(() => {
            // Fetch project localities using the PHP API
            fetch(`https://askresidenci.com/fetchProjectDeveloper.php?id=${builderID}`)
                .then(response => response.json())
                .then(data => {
                    setBuilder(data);
                })
    ...
    // Project Details View start
        ...
        useEffect(() => {
            ...
            fetch(`http://localhost:5000/api/projects/fetchProjectDetailsByID/${id}`)
                .then(response => response.json())
                            ...
                            <div className="tfp-1o20zr1">
                                ...
                                <ScrollSpy>
                                    ...
                                    <section id="location" className="tfp-12c0fe6">
                                        ...
                                        <iframe
                                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3782.207287528021!2d73.7342495750633!3d18.56469118253743!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2bd9e8ab100a9%3A0xf7fbe093aac40a49!2sGodrej%20Hillside%2C%20Pune%20-%20Official!5e0!3m2!1sen!2sin!4v1686056322565!5m2!1sen!2sin"
                                                width="670"
                                                height="450"
                                            ...
                                            <div className="tfp-location-slider">
                                                {projectLocality.map(locality => (
                                                    <div className="item">
                                                        ...
                                                        <div className="cardDistance">{locality.KM} KM</div>
                                                        </div>
                                                    </div>
                                                ))}
                                            </div>
                                                                        ...
                                                                        <div className="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-6 MuiGrid-grid-sm-12">
                                                                            <div className="jss327">
                                                                                <span className="jss328">Established In -
                                                                                    <span style={{fontWeight: 'bold', paddingLeft: '2px'}}>{userObj.estIn}</span>
                                                                                </span>
                                                                            </div>
                                                                            <div className="jss327">
                                                                                <span className="jss328">Total Projects - 
                                                                                    <span style={{fontWeight: 'bold', paddingLeft: '2px'}}>{userObj.totalProject}</span>
                                                                                </span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                            ...
                                            <div data-q="more-about-project" className="tfp-fq1k4c">
                                                ...
                                                <div className="horizontal-TOPBUILDER-carousel2" id="horizontal-TOPBUILDER-carousel">
                                                    ...
                                                    {trendingProjects.slice(0, 8).map((userObj, index) => {
                                                        ...
                                                        const inputString = project.locality;
                                                        const convertedString = convertFirstLetterToLowercase(inputString);
                                                        if (userObj.locality === convertedString || userObj.locality === project.locality) {
                                                            return (
                                                                <>
                                                                    <div className="infoCard">
                                                                        <div className="css-fyv0ia">
                                                                            ...
                                                                            <div className="info">
                                                                                ...
                                                                                <div className="address1">{userObj.BHk} Apartments</div>
                                                                                ...
                                                                                <Link to={`/projects/view-details/${userObj.id}/${userObj.builderID.slice(1, -1)}`} target="_blank">
                                                                                    <button className="ViewDetails2">View Details</button>
                                                                                </Link>
                                                                            </div>
                                                                        </div>
                                                                    </div>
